...
## Illustrations
!["Maillage circulaire"](Images/circ_maillage.png){:style="display:block; margin-left:auto; margin-right:auto"}
!["Solution"](Images/circ_sol.png){:style="display:block; margin-left:auto; margin-right:auto"}